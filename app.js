...
function fNameCheck() {
    ...
    if (fName.value === "") {
        ...
        fName.style.backgroundImage = 'url(/intro-component-with-signup-form-master/images/icon-error.svg)';
...
function lNameCheck() {
    if (lName.value === "") {
        ...
        lName.style.backgroundImage = 'url(/intro-component-with-signup-form-master/images/icon-error.svg)';
...
function emailCheck() {
    ...
    if (!isValidEmail || email.value === "") {
        ...
        email.style.backgroundImage = 'url(/intro-component-with-signup-form-master/images/icon-error.svg)';
...
function passwordCheck() {
    if (password.value === "") {
        ...
        password.style.backgroundImage = 'url(/intro-component-with-signup-form-master/images/icon-error.svg)';
